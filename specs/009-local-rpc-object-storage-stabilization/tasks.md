...
- [x] T077 [US4] Record learner catch-up validation in `specs/009-local-rpc-object-storage-stabilization/task-reports/t077-record-learner-catch-up-validation.md` (验证: `test_raft_log_replication`, `test_raft_snapshot_catchup`, `integrated_object_storage_quorum`)
...
- [x] T078 [P] [US4] Add 3 voters + 2 ready learners batch promote test in `tests/integrated_object_storage_quorum_test.cpp` (验证: `integrated_object_storage_quorum`)
- [x] T079 [P] [US4] Add no committed 4-voter history assertion in `tests/integrated_object_storage_quorum_test.cpp` (验证: `integrated_object_storage_quorum`)
...
- [x] T088 [US4] Record batch promote validation in `specs/009-local-rpc-object-storage-stabilization/task-reports/phase-09-batch-promote.md` (验证: `integrated_object_storage_quorum`, `metadata_failover_test`, `test_raft_snapshot_restart`)
...
- [x] T102 [P] [US6] Add multi-ViewNode self-refresh and peer-sync failover coverage in `tests/view_failover_test.cpp` (验证: `view_failover_test`, `test_view_node_discovery`, `ctest --preset debug-tests -R "ViewFailover|ViewNode" --output-on-failure`)
