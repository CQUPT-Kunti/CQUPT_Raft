...
- [ ] T034 [US1] Record merge behavior and stale snapshot limitations in `specs/009-local-rpc-object-storage-stabilization/task-reports/phase-04-view-merge.md` (验证: `test_view_node_discovery`)
...
- [ ] T044 [US2] Record dual ViewNode validation in `specs/009-local-rpc-object-storage-stabilization/task-reports/phase-05-view-peer-sync.md` (验证: `test_view_node_discovery`, local RPC status)
...
- [ ] T064 [US4] Ensure ViewNode metadata observations remain non-authoritative in `modules/view/view_registry.cpp` and `modules/raft/service/metadata_service_impl.cpp` (验证: `test_view_node_discovery`, `integrated_object_storage_quorum`)
- [ ] T065 [US4] Record join API and safety validation in `specs/009-local-rpc-object-storage-stabilization/task-reports/phase-07-metadata-join.md` (验证: `metadata_client_scenario_test`, `integrated_object_storage_quorum`)
...
- [ ] T075 [US4] Enable learner snapshot install and applied progress tracking in `modules/raft/replication/replicator.cpp` and snapshot integration paths (验证: `test_raft_snapshot_catchup`, `test_raft_snapshot_restart`)
- [ ] T076 [US4] Add pending learner / ready-to-promote / waiting-for-pair status reporting in `modules/raft/service/metadata_service_impl.cpp` (验证: `integrated_object_storage_quorum`)
