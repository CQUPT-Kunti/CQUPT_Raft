...
| Windows persistence / segment / storage 红灯 | 已收口 | 0 | Windows focused rerun 已确认原始 `6` 个 T040 项全部转绿；当前无独立剩余项 | T040 |
...
| 其他 / 待进一步分类 | 当前无独立项 | 0 | 当前 `9` 项都能先落到上面几类 | T042 |
...
| `test_raft_segment_storage` | FAIL | 3 | Windows durability semantics adapt-or-defer | T042 |
...
当前无独立剩余 `T040` 失败项。Windows focused rerun 已确认原始 `6` 个
platform-neutral persistence / segment / storage 红灯全部转绿，并已从失败矩阵删除。
