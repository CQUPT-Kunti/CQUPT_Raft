...
- [X] T067 [P] [US4] Add StorageNode first-start identity allocation test in `tests/node_identity_test.cpp`
- [X] T068 [P] [US4] Add restart reuses node_id test in `tests/node_identity_test.cpp`
- [X] T069 [P] [US4] Add identity/config mismatch failure test in `tests/node_identity_test.cpp`
- [X] T070 [P] [US4] Add MetadataNode raft_id generated by config test in `tests/cluster_config_test.cpp`
