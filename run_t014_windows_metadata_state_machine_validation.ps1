...
$OutDir = "tmp"
$LogFile = Join-Path $OutDir "t015-windows-metadata-state-machine-test.log"
...
try {
    Write-Host "==== T015 Windows MetadataStateMachine Validation ===="
    ...
    Write-Host ""
    Write-Host "==== Result ===="
    Write-Host "T015 Windows MetadataStateMachine validation PASS"
